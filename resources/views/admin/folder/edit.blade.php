...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit Folder</h5>
                    ...
                    <form action="{{ route($currentRoutePrefix . '.data-folder.update', $data_folder)}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="folder" value="{{ $data_folder->folder }}">
                            </div>
                        </div>

                        <div class="row mb-3 mb-3-start" style="margin-top: 30px!important;">
                            <div class="col-md-12 d-flex justify-content-start">
                                <a href="{{ route($currentRoutePrefix . '.data-folder.index') }}" class="btn btn-secondary me-2">Kembali</a>
